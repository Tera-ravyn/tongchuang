...
const func = [
  {
    title: "开通赞赏功能",
    icon: <PayFunc className="w-16 h-16 text-white stroke-[0.65]" />,
    context: [
      {
        title: "什么是赞赏功能？",
        context:
  ...
  {
    title: "开通同创高级会员",
    icon: <Electric className="w-16 h-16 text-white" />,
    context: [
      {
        title: "高级会员的功能",
        context:
  ...
  {
    title: "开通付费密码锁作品",
    icon: <Bone className="w-16 h-16 text-white" />,
    context: [
      {
        title: "付费密码锁是什么？",
        context:
...
const Pay = () => {
  return (
    <div className="p-4 text-white flex flex-col items-stretch gap-y-4">
      {func.map((item, index) => {
        return (
          <div
            key={index}
            className="gap-y-2 bg-neutral-600 rounded-lg pl-6 pr-2 py-4 flex flex-col items-center "
          >
            ...
            <div className="grid grid-cols-[1fr_90px] items-center gap-x-2 w-full justify-between">
              ...
              <div className="flex flex-col items-center gap-y-2">
                {item.icon}
                <button className="bg-[#9E4949] font-title text-[14px] px-2 py-1 rounded-xl">
                  开通功能
                </button>
              </div>
            </div>
