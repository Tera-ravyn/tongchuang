...
const Discovery = () => {
  ...
  return (
    <div className="">
      ...
      <CustomPopup
        right={
          <button className="rounded-lg bg-neutral-700 px-4 text-white ">
            发送
          </button>
        }
        state={post}
      ...
      <div className="w-full sticky top-0 z-[100] ">
        ...
        >
          <button
            ...
            className={`transition-all duration-300 ease-in-out rounded-md  text-white whitespace-nowrap ${
              open ? " px-4 bg-bblack " : " bg-transparent "
            }`}
          >
            {open ? (
